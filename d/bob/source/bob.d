...
string hey(string input)
{
    ...
    if (isShouting(input) && isQuestion(input)) {
...
bool isShouting(string input)
{
    auto replaceRegex = regex(r"[^a-zA-Z]", "g");
    string r = replaceAll(input, replaceRegex, "");

    auto m = matchFirst(r, "^[A-Z]+$");
